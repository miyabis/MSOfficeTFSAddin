...
Public Class TfsRibbon
    ...
    Private _docsStat As IDictionary(Of Excel.Workbook, CommandEnable) = New Dictionary(Of Excel.Workbook, CommandEnable)
...
#Region " リボン "
    ...
    Private Sub TfsExcelRibbon_Load(ByVal sender As System.Object, ByVal e As RibbonUIEventArgs) Handles MyBase.Load
        Init()
    End Sub

    Private Sub TfsExcelRibbon_Close(sender As Object, e As EventArgs) Handles Me.Close
...
#Region " VBA "
    ...
    Private Sub btnScriptExport_Click(sender As Object, e As RibbonControlEventArgs) Handles btnScriptExport.Click
        ...
        book = DirectCast(_document.ActiveDocument, Excel.Workbook)
...
#Region " Method "
    ...
    Public Sub SetEnabled(ByVal Wb As Microsoft.Office.Interop.Excel.Workbook, ByVal force As Boolean, Optional ByVal groupDisable As Boolean = False)
        SyncLock lockObject
    ...
    Public Sub RemoveEnables(ByVal Doc As Excel.Workbook)

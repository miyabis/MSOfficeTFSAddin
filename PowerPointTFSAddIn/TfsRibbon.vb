...
Public Class TfsRibbon
    ...
    Private _docsStat As IDictionary(Of PowerPoint.Presentation, CommandEnable) = New Dictionary(Of PowerPoint.Presentation, CommandEnable)
...
#Region " VBA "
    ...
    Private Sub btnScriptExport_Click(sender As Object, e As RibbonControlEventArgs) Handles btnScriptExport.Click
        ...
        Dim book As PowerPoint.Presentation
        book = DirectCast(_document.ActiveDocument, PowerPoint.Presentation)
...
#Region " Method "
    ...
    Public Sub SetEnabled(ByVal Wb As Microsoft.Office.Interop.PowerPoint.Presentation, ByVal force As Boolean, Optional ByVal groupDisable As Boolean = False)
        SyncLock lockObject
    ...
    Public Sub RemoveEnables(ByVal Doc As PowerPoint.Presentation)

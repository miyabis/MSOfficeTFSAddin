...
Public Class TfsRibbon
    ...
    Private _docsStat As IDictionary(Of Visio.Document, CommandEnable) = New Dictionary(Of Visio.Document, CommandEnable)
...
#Region " VBA "
    ...
    Private Sub btnScriptExport_Click(sender As Object, e As RibbonControlEventArgs) Handles btnScriptExport.Click
        ...
        doc = DirectCast(_document.ActiveDocument, Visio.Document)
...
#Region " Method "
    ...
    Public Sub SetEnabled(ByVal Wb As Microsoft.Office.Interop.Visio.Document, ByVal force As Boolean, Optional ByVal groupDisable As Boolean = False)
    ...
    Public Sub RemoveEnables(ByVal Doc As Visio.Document)
